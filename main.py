...
with open(file_path, "rb") as file:
    ...
    data = {"file_base64": base_64_file, "content_type": "image/jpeg"} # Remember to change this to the correct content type
...
for i in range(60 * 5):  # Poll every second for 5 minutes
    ...
    if response_data and "status" in response_data: 
        if response_data["status"] == "PENDING" or response_data["status"] == "PROCESSING":
